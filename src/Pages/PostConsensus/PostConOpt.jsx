            ...
            <div className="post_home postconsensus_opt">
                <div>
                    <div className="post_header">
                        ...
                        <h2 className="text_darkblue">Post a <strong className="text_lightpurple">Consensus Forming!</strong> </h2>
                    ...
                    <div className="category_select">
                        ...
                        <div className="co_box">
                            <div className="co_option_box">
                                <select className="form-select border_solid bluegreen_border text_bluegreen" aria-label="Default select example">
                                    <option value={1}>Option A</option>
                                    <option value={2}>Option B</option>
                                    <option value={3}>Option C</option>
                                </select>
                                <input className="full_input text_lightgray border_solid bluegreen_border" placeholder="Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam" type="text" />
                            </div>
                        </div>
                        ...
                        <div className="pcontinue_btn mt-3">
                        ...
                        <button className="me-3 cus_width100 text_bluegreen bg_white border_solid bluegreen_border"
                            onClick={() => { history.push("/post-receive") }}
                        >Back</button>
